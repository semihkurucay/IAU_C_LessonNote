...
//Kullanýcýdan ay numarasýný alarak mevsimini ekrana yazdýrýyoruz
/*
int main(){
	int mounth;
...
//Kullanýcýdan iki basamaklý sayý alýp yazý halini ekrana yazdýrýn
int main(){
	int sayi, on;
